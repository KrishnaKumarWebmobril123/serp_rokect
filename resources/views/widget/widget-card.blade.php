                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div class="d-flex flex-column text-center align-items-center justify-content-between ">
                                ...
                                <div class="card-profile-progress">
                                    ...
                                    <img src="{{asset('public/images/avatars/01.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid rounded-circle card-img">
                                    <img src="{{asset('public/images/avatars/avtar_1.png')}}" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-circle card-img">
                                    <img src="{{asset('public/images/avatars/avtar_2.png')}}" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-circle card-img">
                                    <img src="{{asset('public/images/avatars/avtar_4.png')}}" alt="User-Profile" class="theme-color-green-img img-fluid rounded-circle card-img">
                                    <img src="{{asset('public/images/avatars/avtar_5.png')}}" alt="User-Profile" class="theme-color-yellow-img img-fluid rounded-circle card-img">
                                    <img src="{{asset('public/images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-circle card-img">
                                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex  justify-content-start align-items-center mb-3">
                            <div class="pe-3">
                                <img src="{{asset('public/images/avatars/02.png')}}" class="rounded-circle p-1 bg-soft-danger" width="60" height="60" alt="1">
                            </div>
                            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center">
                            <div class="pe-3">
                                <img src="{{asset('public/images/avatars/03.png')}}" class="rounded-circle bg-soft-primary p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{asset('public/images/avatars/04.png')}}" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{asset('public/images/avatars/05.png')}}" class="rounded-circle bg-soft-info p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <div class="pe-3">
                                <img src="{{asset('public/images/avatars/02.png')}}" class="rounded-circle bg-soft-danger p-1" width="50" height="50" alt="1">
                            </div>
                            <div>
                        ...
                        <div class="user-post-data">
                            <div class="d-flex flex-wrap">
                                <div class="media-support-user-img me-3">
                                    <img class="rounded-circle p-1 bg-soft-danger img-fluid avatar-60" src="{{asset('public/images/avatars/02.png')}}" alt="">
                                </div>
                        ...
                        <div class="comment-area mt-3">
                            ...
                            <ul class="post-comments p-0 list-inline">
                                <li class="mb-3">
                                    <div class="d-flex flex-wrap">
                                        <div class="user-img">
                                            <img src="{{asset('public/images/avatars/03.png')}}" alt="userimg" class="p-1 bg-soft-primary avatar-60 rounded-circle img-fluid">
                                        </div>
                    ...
                    <div class="card-body">
                        <ul class="media-story m-0 p-0">
                            <li class="d-flex mb-4 align-items-center active">
                                <img src="{{asset('public/images/avatars/04.png')}}" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <img src="{{asset('public/images/avatars/02.png')}}" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-danger img-fluid">
                                <div class="stories-data ms-3">
                                    <h5>Ira Membrit</h5>
                            ...
                            <li class="d-flex align-items-center">
                                <img src="{{asset('public/images/avatars/03.png')}}" alt="story-img" class="avatar-50 rounded-circle p-1 bg-soft-primary img-fluid">
                                <div class="stories-data ms-3">
                                    <h5>Bob Frapples</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-card grid-cols-3">
                            <a data-fslightbox="gallery" href="{{asset('public/images/icons/04.png')}}">
                                <img src="{{asset('public/images/icons/04.png')}}" class="img-fluid bg-soft-info rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/shapes/02.png')}}">
                                <img src="{{asset('public/images/shapes/02.png')}}" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/icons/08.png')}}">
                                <img src="{{asset('public/images/icons/08.png')}}" class="img-fluid bg-soft-info rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/shapes/04.png')}}">
                                <img src="{{asset('public/images/shapes/04.png')}}" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/icons/02.png')}}">
                                <img src="{{asset('public/images/icons/02.png')}}" class="img-fluid bg-soft-warning rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/shapes/06.png')}}">
                                <img src="{{asset('public/images/shapes/06.png')}}" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/icons/05.png')}}">
                                <img src="{{asset('public/images/icons/05.png')}}" class="img-fluid bg-soft-danger rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/shapes/04.png')}}">
                                <img src="{{asset('public/images/shapes/04.png')}}" class="img-fluid bg-soft-primary rounded" alt="profile-image">
                            </a>
                            <a data-fslightbox="gallery" href="{{asset('public/images/icons/01.png')}}">
                                <img src="{{asset('public/images/icons/01.png')}}" class="img-fluid bg-soft-success rounded" alt="profile-image">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="twit-feed">
                            ...
                            <img src="{{asset('public/images/avatars/01.png')}}" alt="User-Profile" class="theme-color-default-img img-fluid avatar-60 me-3">
                            <img src="{{asset('public/images/avatars/avtar_1.png')}}" alt="User-Profile" class="theme-color-purple-img img-fluid avatar-60 me-3">
                            <img src="{{asset('public/images/avatars/avtar_2.png')}}" alt="User-Profile" class="theme-color-blue-img img-fluid avatar-60 me-3">
                            <img src="{{asset('public/images/avatars/avtar_4.png')}}" alt="User-Profile" class="theme-color-green-img img-fluid avatar-60 me-3">
                            <img src="{{asset('public/images/avatars/avtar_5.png')}}" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar-60 me-3">
                            <img src="{{asset('public/images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid avatar-60 me-3">
                        ...
                        <div class="twit-feed">
                            <div class="d-flex align-items-center mb-4">
                                <img class="rounded-pill p-1 bg-soft-primary img-fluid avatar-60 me-3" src="{{asset('public/images/avatars/03.png')}}" alt="">
                                <div class="media-support-info">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-inline m-0 p-0">
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img src="{{asset('public/images/icons/05.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-danger rounded-pill"><img src="{{asset('public/images/icons/03.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Robert Fox</h6>
                                <p class="mb-0">4 mutual friends</p>
                                </div>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-dark rounded-pill"><img src="{{asset('public/images/icons/06.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Jenny Wilson</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-primary rounded-pill"><img src="{{asset('public/images/icons/07.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Cody Fisher</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-info rounded-pill"><img src="{{asset('public/images/icons/04.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Bessie Cooper</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-warning rounded-pill"><img src="{{asset('public/images/icons/02.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Wade Warren</h6>
                            ...
                            <li class="d-flex mb-4 align-items-center">
                                <div class="img-fluid bg-soft-success rounded-pill"><img src="{{asset('public/images/icons/01.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Guy Hawkins</h6>
                            ...
                            <li class="d-flex align-items-center">
                                <div class="img-fluid bg-soft-info rounded-pill"><img src="{{asset('public/images/icons/08.png')}}" alt="story-img" class="rounded-pill avatar-40"></div>
                                <div class="ms-3 flex-grow-1">
                                <h6>Floyd Miles</h6>
