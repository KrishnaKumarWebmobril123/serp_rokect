            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-md-0 mt-4">
                    ...
                    <ul class="list-unstyled p-0 m-0 d-flex mt-4">
                        <li>
                            <a href="#"><img src="{{ asset('public/images/brands/08.png') }}" alt="fb"
                                    loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('public/images/brands/09.png') }}" alt="gm"
                                    loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('public/images/brands/10.png') }}" alt="im"
                                    loading="lazy" class="rounded-pill"></a>
                        </li>
                        <li class="ps-3">
                            <a href="#"><img src="{{ asset('public/images/brands/13.png') }}" alt="li"
                                    loading="lazy" class="rounded-pill"></a>
                        </li>
                    </ul>
                </div>
