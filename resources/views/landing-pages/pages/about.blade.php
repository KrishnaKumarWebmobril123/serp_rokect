        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 mb-3 mt-4 mt-md-0">
                    <img src="{{ asset('public/images/landing-pages/images/home-4/banner-left.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col-md-4 mb-3">
                    <img src="{{ asset('public/images/landing-pages/images/home-4/banner-right.webp') }}" alt=""
                        class="img-fluid ">
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <a hrer="#" class="btn btn-primary mt-4">Know More</a>
                    <img src="{{ asset('public/images/landing-pages/images/home-4/service.webp') }}" alt=""
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mt-4 mt-md-0">
                    <img src="{{ asset('public/images/landing-pages/images/home-4/Image-1.webp') }}" alt=""
                        class="img-fluid ">
                </div>
            </div>
        </div>
