        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 banner-one-img text-center ms-2 ms-sm-0">
                    <img src="{{ asset('public/images/landing-pages/images/home-1/banner-top.webp') }}" alt=""
                        class="img-fluid ">
                </div>
    ...
    <div class="section-padding bg-white">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{ asset('public/images/landing-pages/images/home-1/aboutus.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col-md-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-center store-btn flex-wrap">
                        <img src="{{ asset('public/images/landing-pages/images/home-1/playstore.webp') }}" alt=""
                            class="img-fluid mb-3 mb-md-0">
                        <img src="{{ asset('public/images/landing-pages/images/home-1/appstore.webp') }}" alt=""
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <img src="{{ asset('public/images/landing-pages/images/home-1/dwn-1.webp') }}" alt=""
                                class="img-fluid">
                        </div>
                        <div class="col">
                            <img src="{{ asset('public/images/landing-pages/images/home-1/dwn-2.webp') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                </div>
    ...
    <div class="section-padding ">
        <div class="container">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
                <div class="col">
                    <img src="{{ asset('public/images/landing-pages/images/home-1/01.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col">
                    <img src="{{ asset('public/images/landing-pages/images/home-1/02.webp') }}" alt=""
                        class="img-fluid ">
                </div>
                <div class="col">
                    <img src="{{ asset('public/images/landing-pages/images/home-1/03.webp') }}" alt=""
                        class="img-fluid ">
                </div>
            </div>
        </div>
