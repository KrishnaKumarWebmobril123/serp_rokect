<x-app-layout layout="simple" :assets="$assets ?? []">
    ...
    <div class="header"
        style="background: url({{ asset('public/images/dashboard/top-image.jpg') }}); background-size: cover; background-repeat: no-repeat; height: 100vh;position: relative;">
        <div class="main-img">
            <div class="container">
                    ...
                    <div class="ms-3">
                        <a class="bg-white btn btn-light d-flex" target="_blank"
                            href="https://github.com/iqonicdesignofficial/hope-ui-laravel-dashboard"><img
                                src="{{ asset('public//images/brands/23.png') }}" width="24px" height="24px"><span
