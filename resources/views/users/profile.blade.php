               ...
               <div class="d-flex flex-wrap align-items-center justify-content-between">
                  <div class="d-flex flex-wrap align-items-center">
                     <div class="profile-img position-relative me-3 mb-3 mb-lg-0">
                        ...
                        <img src="{{asset('public/images/avatars/avtar_1.png')}}" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-pill avatar-100">
                        <img src="{{asset('public/images/avatars/avtar_2.png')}}" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-pill avatar-100">
                        <img src="{{asset('public/images/avatars/avtar_4.png')}}" alt="User-Profile" class="theme-color-green-img img-fluid rounded-pill avatar-100">
                        <img src="{{asset('public/images/avatars/avtar_5.png')}}" alt="User-Profile" class="theme-color-yellow-img img-fluid rounded-pill avatar-100">
                        <img src="{{asset('public/images/avatars/avtar_3.png')}}" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-pill avatar-100">
                     </div>
         ...
         <div class="card-body">
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                  <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2" src="{{asset('public/images/icons/03.png')}}" alt="">
            ...
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                  <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary" src="{{asset('public/images/icons/04.png')}}" alt="">
                  <div class="media-support-info">
            ...
            <div class="twit-feed">
               <div class="d-flex align-items-center mb-2">
                     <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2" src="{{asset('public/images/icons/02.png')}}" alt="">
                  <div class="mt-2">
         ...
         <div id="profile-feed" class="tab-pane fade active show">
            <div class="card">
                  ...
                  <div class="header-title">
                     <div class="d-flex flex-wrap">
                        <div class="media-support-user-img me-3">
                           <img class="rounded-pill img-fluid avatar-60 bg-soft-danger p-1 ps-2" src="{{asset('public/images/avatars/02.png')}}" alt="">
                        </div>
               ...
               <div class="card-body p-0">
                  <div class="user-post">
                     <a href="javascript:void(0);"><img src="{{asset('public/images/pages/02-page')}}.png" alt="post-image" class="img-fluid"></a>
                  </div>
                  <div class="comment-area p-3">
                     ...
                     <ul class="list-inline p-0 m-0">
                        <li class="mb-2">
                           <div class="d-flex">
                              <img src="{{asset('public/images/avatars/03.png')}}" alt="userimg" class="avatar-50 p-1 pt-2 bg-soft-primary rounded-pill img-fluid">
                              <div class="ms-3">
                        ...
                        <li>
                           <div class="d-flex">
                              <img src="{{asset('public/images/avatars/04.png')}}" alt="userimg" class="avatar-50 p-1 bg-soft-danger rounded-pill img-fluid">
                              <div class="ms-3">
            ...
            <div class="card">
               <div class="card-header d-flex align-items-center justify-content-between pb-4">
                  <div class="header-title">
                     <div class="d-flex flex-wrap">
                        <div class="media-support-user-img me-3">
                           <img class="rounded-pill img-fluid avatar-60 p-1 bg-soft-info" src="{{asset('public/images/avatars/05.png')}}" alt="">
                        </div>
                        <div class="media-support-info mt-2">
               ...
               <div class="card-body">
                  <ul class="list-inline m-0 p-0">
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/01.png')}}" alt="story-img" class="rounded-pill avatar-40">
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/05.png')}}" alt="story-img" class="rounded-pill avatar-40">
                        <div class="ms-3 flex-grow-1">
                           <h6>Paul Molive</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/02.png')}}" alt="story-img" class="rounded-pill avatar-40">
                        <div class="ms-3 flex-grow-1">
                           <h6>Anna Mull</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/03.png')}}" alt="story-img" class="rounded-pill avatar-40">
                        <div class="ms-3 flex-grow-1">
                           <h6>Paige Turner</h6>
                           <p class="mb-0">trainee</p>
                        </div>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/04.png')}}" alt="story-img" class="rounded-pill avatar-40">
                        <div class="ms-3 flex-grow-1">
                           <h6>Barb Ackue</h6>
                           <p class="mb-0">Web Designer</p>
                        </div>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="{{asset('public/images/avatars/03.png')}}" alt="story-img" class="rounded-pill avatar-40">                              <div class="ms-3 flex-grow-1">
                           <h6>Ira Membrit</h6>
               ...
               <div class="card-body">
                  <div class="text-center">
                     <div class="user-profile">
                        <img src="{{asset('public/images/avatars/01.png')}}" alt="profile-img" class="rounded-pill avatar-130 img-fluid">
                     </div>
                     <div class="mt-3">
         ...
         <div class="card-body">
            <ul class="list-inline m-0 p-0">
               <li class="d-flex mb-4 align-items-center active">
                  <img src="{{asset('public/images/icons/06.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid">
                  <div class="ms-3">
                     <h5>Web Design</h5>
               ...
               <li class="d-flex mb-4 align-items-center">
                  <img src="{{asset('public/images/icons/03.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger">
                  <div class="ms-3">
                     <h5>App Design</h5>
               ...
               <li class="d-flex align-items-center">
                  <img src="{{asset('public/images/icons/07.png')}}" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-primary img-fluid">
                  <div class="ms-3">
