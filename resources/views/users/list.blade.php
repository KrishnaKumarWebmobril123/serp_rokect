            ...
            <div class="card-body px-0">
               <div class="table-responsive">
                  <!-- <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                     ...
                     <tbody>
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/01.png')}}" alt="profile"></td>
                           <td>Anna Sthesia</td>
                           <td>(760) 756 7568</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/02.png')}}" alt="profile"></td>
                           <td>Brock Lee</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/03.png')}}" alt="profile"></td>
                           <td>Dan Druff</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/04.png')}}" alt="profile"></td>
                           <td>Hans Olo</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/05.png')}}" alt="profile"></td>
                           <td>Lynn Guini</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="{{asset('public/images/shapes/06.png')}}" alt="profile"></td>
                           <td>Eric Shun</td>
